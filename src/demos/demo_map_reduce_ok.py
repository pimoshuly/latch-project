...
@task(
    ...
    constraints=Constraints(
        allow_outgoing_to_names=["mapper1", "mapper2", "mapper3", "mapper4", "mapper5"]
    ),
)
def data_source():
...
@task(
    name="mapper1",
    constraints=Constraints(
        allow_incoming_from_names=["data_source"], allow_outgoing_to_names=["reducer"]
    ),
)
def mapper1():
